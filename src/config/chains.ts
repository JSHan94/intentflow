...
export const ROLLUP_ACTIONS: Record<string, RollupAction[]> = {
  ...
  minievm: [
    ...
    { id: 'bridge-init', label: 'Bridge INIT', intent: 'Bridge INIT from Initia L1 to miniEVM', color: '#B388FF' },
    { id: 'explore', label: 'Explore', intent: 'Show my balances on miniEVM', color: '#B388FF' },
  ],
  initia_l1: [
